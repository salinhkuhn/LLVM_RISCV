...
theorem translation_or :
  OR_LLVM (Ctxt.Valuation.ofHVector lh_llvm) = some x →
   x = OR_RV64 (Ctxt.Valuation.ofHVector lh_riscv) := by
...
theorem translation_xor :
  XOR_LLVM (Ctxt.Valuation.ofHVector lh_llvm) = some x →
   x = XOR_RV64 (Ctxt.Valuation.ofHVector lh_riscv) := by
...
theorem translation_shl :
  shl_LLVM (Ctxt.Valuation.ofHVector lh_llvm) = some x →
    x = shl_RV64 (Ctxt.Valuation.ofHVector lh_riscv) := by
...
theorem translation_sub :
  SUB_LLVM (Ctxt.Valuation.ofHVector lh_llvm) = some x →
   x = SUB_RV64 (Ctxt.Valuation.ofHVector lh_riscv) := by
