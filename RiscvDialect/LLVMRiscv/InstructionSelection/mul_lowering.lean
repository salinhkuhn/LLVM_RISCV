...
-- to do ask the inhabited error to be able to apply the verfied rewrites in a more ways. 
/- def out1 :=  rewritePeepholeRecursively 10
(LLVMToRiscvPeepholeRewriteRefine.toPeepholeUNSOUND llvm_mul_lower_riscv_noflag) _mul_riscv_test1 -/
